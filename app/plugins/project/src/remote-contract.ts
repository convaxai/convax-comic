...
import { PROJECT_FILES_NAMESPACE, PROJECT_FILES_RESPONSE_CAP } from './contracts.js'
...
const METHODS = ['open', 'list', 'wait', 'close'] as const satisfies readonly Method[]
...
function descriptor(method: Method): InvocationDescriptor {
  return Object.freeze({
    ...
    ...(method === 'wait' ? { cancellation: { parameter: 'signal' as const } } : {}),
